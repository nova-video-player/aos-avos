...
#define sonicInputSamplesBuffered sonicIntInputSamplesBuffered
#define sonicProcessingSpeed sonicIntProcessingSpeed
...
/* AVOS timing observations. Caller serializes these with writes/reads.
   Input retained for lookahead is not yet represented by returned output.
   Processing speed includes the play-time budget of retained input. */
